...
\Title{\selectlanguage{portuguese}Aprendizagem automática para o diagnostico de lesões de pele (MÁXIMO 70 CARACTERES)}
...
\Title{\selectlanguage{english}Machine learning for the diagnosis of skin lesions (MAX 70 CHARACTERS)}
...
\Dedication{Dedico este trabalho aos meus pais, amigos, e em especial ao orientador e co-orientadora.}
...
\Abstract{Palavras Chave}{imagem médica, aprendizagem profunda, rede neuronal convolucional, aprendizagem por transferência, diagnósticos de lesões na pele, classificação de multiplas classes.}
...
\Abstract{Keywords}{medical imaging, deep learning, convolutional neural network, transfer learning, skin lesion diagnosis, multi-class classification.}
